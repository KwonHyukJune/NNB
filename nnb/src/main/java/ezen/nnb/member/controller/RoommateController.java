...
private IgnoreService ignoreService;
	...
	totalCount = searchRoommate.size();
		...
		@ResponseBody
		public ModelAndView listAddFavRoommate(HttpServletRequest request, HttpServletResponse response,CommandMap commandMap)throws Exception {
	...
	@ResponseBody
	public ModelAndView detailAddFavRoommate(HttpServletRequest request, HttpServletResponse response,CommandMap commandMap)throws Exception {
		ModelAndView mv=new ModelAndView();
		HttpSession session=request.getSession();
