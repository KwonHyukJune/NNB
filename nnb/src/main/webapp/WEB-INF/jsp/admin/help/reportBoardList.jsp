...
<body>
	<h1><div style="width:880px; margin: 0 auto; text-align: center;">신고 관리</div></h1>
	<br/>
	
<div style="margin: 0 auto; width:880px; text-align: center;">
<button id="btn" type="button" onclick="location.href='reportBoardList.jsp'">신고 게시글 관리</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
<button id="btn" type="button" onclick="location.href='reportMateList.jsp'" >신고 룸메이트 관리</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
</div>
<br/><br/><br/><br/>
...
<select name="searchType" style="height: 29px; ">
		...
		<option value="w"
			...
			<c:out value="${cri.searchType eq 'w'?'selected':''}"/>></option>
 	...
 	<select name="searchType" style="height: 29px; ">
		...
		<option value="t"
			...
			<c:out value="${cri.searchType eq 't'?'selected':''}"/>>신고 유형</option>
...
<li style="width: 10%; height: 28px;background-color:#D4F4FA; float:left; list-style:none;">처리상태</li>
...
<br/>
<ul>
<li style="width: 10%; height: 28px;background-color:white; float:left; list-style:none;">${REPORT_NUM}</li>
<li style="width: 10%; height: 28px;background-color:white; float:left; list-style:none;">${REPORT_STATE}</li>
