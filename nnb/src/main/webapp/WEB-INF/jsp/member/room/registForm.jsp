...
<div class="table">
	...
	<div class="tbody">
		...
		<div class="b">
			...
			<div id="monthly">
				<input type="number" name="deposit" id="deposit" placeholder="보증금">/
				<input type="number" name="pay" id="pay" placeholder="월세"> 만원
			</div>
			<div id="jeonsediv">
...
<div class="table">
	...
	<div class="tbody">
		...
		<div class="b">
			<div>
				공급 면적 
				<input type="number" name="sup_p" id="sup_p"> 평 
				<input type="number" name="sup_m" id="sup_m"> m2
			</div>
			<div>
				전용 면적 
				<input type="number" name="real_p" id="real_p"> 평 
...
<div class="table">
	...
	<div class="tbody">
		...
		<div class="b">
			...
			<input type="checkbox" class="OPTIONS" value="4"><div class="c_button">옷장</div>
			<input type="checkbox" class="OPTIONS" value="5"><div class="c_button">TV</div>
			<input type="checkbox" class="OPTIONS" value="6"><div class="c_button">신발장</div>
			<input type="checkbox" class="OPTIONS" value="7"><div class="c_button">냉장고</div>
			<input type="checkbox" class="OPTIONS" value="8"><div class="c_button">가스레인지</div>
			<input type="checkbox" class="OPTIONS" value="9"><div class="c_button">인덕션</div>
			<input type="checkbox" class="OPTIONS" value="10"><div class="c_button">전자레인지</div>
			<input type="checkbox" class="OPTIONS" value="11"><div class="c_button">전자도어락</div>
			<input type="checkbox" class="OPTIONS" value="12"><div class="c_button">비데</div>
		</div>
